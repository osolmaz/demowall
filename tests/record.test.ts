...
import type { RunResult, SpawnedHandle } from "../src/demowall/exec.js";
import { runRecordCommand, type RecordDeps } from "../src/demowall/record.js";

describe("demowall record", () => {
  ...
  it("launches ghostty with the theme and records the window until it closes", async () => {
    ...
    expect(ghostty.args[2]).toMatch(/^--title=demowall-record-/u);
